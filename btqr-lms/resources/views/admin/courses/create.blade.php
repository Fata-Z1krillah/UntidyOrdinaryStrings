...
<div class="py-4 max-w-2xl">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <h2 class="text-lg font-bold text-gray-900 mb-4">Buat Kelas Baru</h2>
        <form method="POST" action="{{ route('admin.courses.store') }}">
            ...
            <div class="mt-6 flex gap-3">
                <button type="submit" class="px-5 py-2 bg-primary text-white text-sm rounded-lg hover:bg-primary-dark transition-colors">Buat Kelas</button>
